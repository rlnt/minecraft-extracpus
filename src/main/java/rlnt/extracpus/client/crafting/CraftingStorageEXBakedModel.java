...
public abstract class CraftingStorageEXBakedModel implements IBakedModel{
	...
	public CraftingStorageEXBakedModel( VertexFormat format, TextureAtlasSprite ringCorner, TextureAtlasSprite ringHor, TextureAtlasSprite ringVer )
	{
		this.format = format;
