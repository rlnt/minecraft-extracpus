...
public class CraftingStorageEXModel implements IModel {
	...
	public CraftingStorageEXModel(BlockCraftingUnit.CraftingUnitType type) {
		this.type = type;
	}
	...
	public IBakedModel bake(IModelState state, VertexFormat format, Function<ResourceLocation, TextureAtlasSprite> bakedTextureGetter) {
		...
		case STORAGE_16K:
		case STORAGE_64K:
			return new LightBakedEXModel(format, ringCorner, ringSideHor, ringSideVer,
					bakedTextureGetter.apply(LIGHT_BASE), getLightTexture(bakedTextureGetter, type));
		default:
	...
	private static ResourceLocation texture(String name) {
		return new ResourceLocation(ExtraCPUs.MOD_ID, "blocks/" + name);
	}
